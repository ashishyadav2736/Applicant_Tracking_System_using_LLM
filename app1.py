...
# Setup the model configuration for text generation
generation_config = {
    'temperature' : 0,
    'top_p' : 1,
    'top_k' : 32,
...
def generate_response_from_gemini(input_text):
    # Create a Generative Model instance with 'gemini-pro' as the model type
...
AI architect, AI Engineer and big data engineering, your role involves evaluating resumes against the job descriptions.
Recognizing the competitive job market, provide top-notch assistance for resume improvement.
Your goal is to analyze the resume against the given the job description,
assign a percentage match on key criteria, and pinpoint missing keywords accurately.
resume : {text}
description : {job_description}
I want the response in one single string having the structure
{{"Job Description Match":"%", "Missing Keywords":"", :"Candidate Summary":""}}
...
uploaded_file = st.file_uploader("Upload Your Resume", type = ["pdf", "docx"], help = "Please upload a PDF or a DOCX file")
